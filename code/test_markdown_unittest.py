...
class TestMarkdownPy(unittest.TestCase):
    ...
    def test_geq(self):
        ...
        '''
        self.assertEqual( 
                run_markdown('>this should have a <blockquote> tag'),
                '<p><blockquote>this should have a <blockquote> tag</p>')   
